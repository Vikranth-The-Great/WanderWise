...
// Data interfaces
/**
 * Raw attraction data from source.
 */
...
/**
 * Processed attraction with calculated score and standardized fields.
 */
...
/**
 * User preferences structure for optimization.
 */
...
/**
 * Result of the optimization process for a single day.
 */
...
/**
 * Service responsible for selecting and scheduling attractions.
 * Optimizes the itinerary based on user preferences, ratings, and themes.
 */
export class AttractionOptimizer {
  ...
  /**
   * Select top attractions based on user preferences and trip duration.
   * Filters by rating (must be > 0) and sorts by calculated preference score.
   * 
   * @param attractions - List of raw attraction data.
   * @param userPreferences - User's travel preferences.
   * @param tripDuration - Number of days in the trip.
   * @returns List of processed and scored attractions.
   */
   ...
   * Calculate preference score based on user preferences.
   * Weights:
   * - Rating: Base score (0-60)
   * - Popularity: Logarithmic scale (0-25)
   * - Theme Match: Exact/partial matches (0-40)
   * - Duration: Preference match (0-15)
   * - Traveler Type: Specific bonuses (0-10)
   * 
   * @param attraction - Attraction details subset needed for scoring.
  ...
  /**
   * Optimize attraction arrangement for multiple days.
   * Distributes high-scoring attractions across trip duration and optimizes daily routes.
   * 
   * @param selectedAttractions - List of top-scored attractions.
   * @param tripDuration - Number of days.
   * @returns Array of OptimizedDay objects.
   */
